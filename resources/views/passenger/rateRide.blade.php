...
<body class="bg-gray-50">
    ...
    <div class="flex items-center mb-4">
        ...
        <h2 class="text-xl font-bold">Rate Your Passenger</h2>
    </div>
    ...
    <!-- Rating Form -->
    <form method="POST" action="{{ route('driver.submit.rating', $ride->id) }}" class="space-y-6">
    @csrf
...
<div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-green-700">
                    Payment of <strong>MAD {{ number_format($ride->price, 2) }}</strong> has been successfully processed.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-3">
        ...
        <div class="flex justify-between text-amber-600">
            <span>Included surge pricing ({{ number_format($ride->surge_multiplier, 1) }}x)</span>
        ...
        <div class="flex justify-between">
            ...
            <span>MAD {{ number_format($ride->price * 0.25, 2) }}</span>
        </div>
        
        <div class="border-t border-gray-200 pt-3 mt-3 flex justify-between font-medium">
            <span>Your earnings</span>
            <span>MAD {{ number_format($ride->price * 0.75, 2) }}</span>
        </div>
    </div>
</div>
